...
{
    elf_header = (Elf64_Ehdr *)malloc(sizeof(Elf64_Ehdr) * file_num);
    section_headers = (Elf64_Shdr **)malloc(sizeof(Elf64_Shdr *) * file_num);
    sym_tbl_offset = (Elf64_Off *)malloc(sizeof(Elf64_Off) * file_num);
    sym_tbl_size = (Elf64_Xword *)malloc(sizeof(Elf64_Xword) * file_num);
    str_tbl_offset = (Elf64_Off *)malloc(sizeof(Elf64_Off) * file_num);
    str_tbl_size = (Elf64_Xword *)malloc(sizeof(Elf64_Xword) * file_num);
    str_tbl = (char **)malloc(sizeof(char *) * file_num);

    sym_tbl = (Elf64_Sym **)malloc(sizeof(Elf64_Sym *) * file_num);
    sym_tbl_nent = (unsigned int *)malloc(sizeof(unsigned int) * file_num);
    sym_tbl_func = (Elf64_Sym **)malloc(sizeof(Elf64_Sym *) * file_num);
    sym_func_num = (unsigned int *)malloc(sizeof(unsigned int) * file_num);
...
{
    section_headers[idx_of_elf] = (Elf64_Shdr *)malloc(elf_header[idx_of_elf].e_shentsize * elf_header[idx_of_elf].e_shnum);
    section_headers[idx_of_elf] = (Elf64_Shdr *)get_data(section_headers[idx_of_elf], file, elf_header[idx_of_elf].e_shoff,
...
void process_symbol_table(FILE *pFILE, int idx_of_elf)
{
    Elf64_Sym *sym;
    Elf64_Section i;
    Elf64_Section *idx = (Elf64_Section *)malloc(sizeof(Elf64_Section) * sym_tbl_nent[idx_of_elf]);
